...
export const bunkerMatrix: (undefined | bluePrintMatrixElement)[][] = [
	...
	[{ rcl: 1, type: STRUCTURE_ROAD},	{ rcl: 3, type: STRUCTURE_EXTENSION},	undefined,								{ rcl: 2, type: STRUCTURE_EXTENSION},	undefined,								{ rcl: 3, type: STRUCTURE_EXTENSION},	{ rcl: 1, type: STRUCTURE_ROAD}],
	[{ rcl: 1, type: STRUCTURE_ROAD},	{ rcl: 3, type: STRUCTURE_EXTENSION},	{ rcl: 3, type: STRUCTURE_EXTENSION},	{ rcl: 7, type: STRUCTURE_SPAWN},		{ rcl: 3, type: STRUCTURE_EXTENSION},	{ rcl: 3, type: STRUCTURE_EXTENSION},	{ rcl: 1, type: STRUCTURE_ROAD}],
	[undefined,							{ rcl: 1, type: STRUCTURE_ROAD},		{ rcl: 1, type: STRUCTURE_ROAD},		{ rcl: 1, type: STRUCTURE_ROAD},		{ rcl: 1, type: STRUCTURE_ROAD},		{ rcl: 1, type: STRUCTURE_ROAD},		undefined],
]
